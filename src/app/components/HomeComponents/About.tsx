...
const About = (props: Props) => {
  return (
    <div className='w-full lg:px-[130px] flex justify-center gap-x-[50px] items-start lg:py-[90px] lg:text-2xl relative' id='about us'>
       <div className='absolute flex justify-center items-center gap-x-[20px] top-[20px]'>
        <Image src={clinicLogo} alt='' className='lg:w-[70px] lg:h-[70px]' />
